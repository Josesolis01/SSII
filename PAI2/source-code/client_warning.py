...
HOST = "localhost"
PORT = 3030
# CERT_DIR = "certs" # No se usa
# CA_CERT = f"{CERT_DIR}/ca.crt" # No se usa
...
try:
    # Conectamos el socket directamente
    s = client_socket
    s.connect((HOST, PORT))
    print(f"Conectado al servidor INSEGURO en {HOST}:{PORT}") # Mensaje actualizado
