...
def connect_to_ssl_server():
    ...
    ssl_context.check_hostname = True  # No verifica el nombre del host
    ssl_context.verify_mode = ssl.CERT_REQUIRED # No verifica el certificado del servidor (solo para pruebas)
